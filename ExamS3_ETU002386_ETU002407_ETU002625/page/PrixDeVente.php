        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <form class="needs-validation" novalidate>
              ...
              <input type="hidden" name="page" value="PrixDeVente">

              <div class="form-group">
                <label for="">Montant de prix de vente</label>

                <input type="text" name="prixVente" class="form-control" required>
                <div class="invalid-feedback">Montant de prix de vente</div>
              </div>

              <div class="form-group">
                <label for="">Variété du thé</label>
                <select name="idVarieteThe" class="form-select" required>
