...
<script>function filterData() {
    ...
    // Faire une requête AJAX pour appeler la fonction PHP
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'script.php'); // Assurez-vous de remplacer 'fonctions.php' par le bon chemin vers votre fichier PHP
    ...
    var params = 'dmin=' + encodeURIComponent(dmin) + '&dmax=' + encodeURIComponent(dmax);
    xhr.send(params);
}
