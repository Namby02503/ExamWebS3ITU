...
?>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="adminbtn" href="#" data-page="Cueillette.php">
          <i class="bi bi-grid"></i>
          <span>Saisie des cueillettes</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="adminbtn" href="#" data-page="Depense.php">
          <i class="bi bi-type"></i>
          <span>Saisie des depenses</span>
        </a>
      </li><!-- End Fonts Nav -->
      <li class="nav-item">
        <a class="adminbtn" href="#" data-page="Resultat1.php">
          <i class="bi bi-type"></i>
          <span>Resultat</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="adminbtn" href="Resultat1.php" >
          <i class="bi bi-type"></i>
          <span>Precision</span>
        </a>
      </li>
    </ul>
    <a href="resultat.php" id="voirResultat">Voir résultat</a>
  ...
  <main id="main">
    <div id="pageContent" class="container">
      ...
      <?php
if (isset($_GET["repvariete"]) && $_GET["repvariete"]!=null) {
  echo "<script>alert('" . $_GET["repvariete"] . "');</script>";
  if (isset($_GET["page"])) {
...
?>
  ...
  <li class="nav-item">
        <a class="adminbtn" href="#" data-page="resultat.php">
          <i class="bi bi-type"></i>
          <span>Resultat</span>
        </a>
      </li>
